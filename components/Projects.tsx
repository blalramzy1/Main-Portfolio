...
import Project2 from '../public/assets/projects/projects 2.jpg'
import Project3 from '../public/assets/projects/projects 3.jpg'
import Project4 from '../public/assets/projects/projects 4.jpg'
import Project5 from '../public/assets/projects/projects 5.jpg'
  ...
  return (
    <div id='projects' className='w-full'>
        ...
        <Image width={600} height={300}  className='rounded-xl group-hover:opacity-10' src={Project6} alt="/" />
         ...
         <div className='relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 p-4 rounded-xl group hover:bg-gradient-to-r from-[#5651e5] to-[#b5bec9]'>
        <Image width={500} height={300} className='rounded-xl group-hover:opacity-10' src={Project7} alt="/" />
            <div className='hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>

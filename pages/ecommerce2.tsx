    ...
    <div className='w-full'>
      ...
      <div className='w-screen h-[50vh] relative'>
        ...
        <Image
          ...
          layout='fill'
          objectFit='cover'
          src='https://raw.githubusercontent.com/blalramzy1/pic-protfoilio/main/projects%203.png?token=GHSAT0AAAAAAB7MH46RHXMTSKOO2AD2OMAOZD45OPA'
          alt='/'
        />
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <a
            href='https://github.com/blalramzy1/semi-E-Commerce'
            target='_blank'
            rel='noreferrer'
          >
          ...
          <a
            href='https://sturdy-cracker.surge.sh'
            target='_blank'
            rel='noreferrer'
          >
